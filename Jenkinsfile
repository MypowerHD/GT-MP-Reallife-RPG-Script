node {
	...
	stage('deploy') {
		if (env.BRANCH_NAME != 'master') {
			...
			sh 'ssh root@terratex.eu "xcopy \\"D:/TerraTex/Spiele/GTMP/03_shared_packages/*\\" \\"D:/TerraTex/Spiele/GTMP/01_server/live/resources\\"'
			...
			sh 'ssh root@terratex.eu "xcopy \\"D:/TerraTex/Spiele/GTMP/03_shared_packages/*\\" \\"D:/TerraTex/Spiele/GTMP/01_server/dev/resources\\"'
		}
	}
}
